        ...
        , insertHtmlDialog(0)
{
    ...
    ui->standardTB->insertWidget(ui->actionZoomOut, spacer);

    zoomLabel = new QLabel;
    ui->standardTB->insertWidget(ui->actionZoomOut, zoomLabel);
    ...
    ui->standardTB->insertWidget(ui->actionZoomIn, zoomSlider);
...
void HtmlEditor::setupActions()
{
    ui->actionFormatBold->setIcon(QIcon::fromTheme("format-text-bold"));
    ui->actionFormatItalic->setIcon(QIcon::fromTheme("format-text-italic"));
    ui->actionFormatUnderline->setIcon(QIcon::fromTheme("format-text-underline"));
    ui->actionFormatStrikethrough->setIcon(QIcon::fromTheme("format-text-strikethrough"));
    ui->actionFormatAlignLeft->setIcon(QIcon::fromTheme("format-justify-left"));
    ui->actionFormatAlignCenter->setIcon(QIcon::fromTheme("format-justify-center"));
    ui->actionFormatAlignRight->setIcon(QIcon::fromTheme("format-justify-right"));
    ui->actionFormatAlignJustify->setIcon(QIcon::fromTheme("format-justify-fill"));
    ui->actionEditCopy->setIcon(QIcon::fromTheme("edit-copy"));
    ui->actionEditCut->setIcon(QIcon::fromTheme("edit-cut"));
    ui->actionEditPaste->setIcon(QIcon::fromTheme("edit-paste"));
    ui->actionEditRedo->setIcon(QIcon::fromTheme("edit-redo"));
    ui->actionEditSelectAll->setIcon(QIcon::fromTheme("edit-select-all"));
    ui->actionEditUndo->setIcon(QIcon::fromTheme("edit-undo"));
    ui->actionCreateLink->setIcon(QIcon::fromTheme("insert-link"));

    QList<QAction*> formatActions;
    formatActions << ui->actionFormatBold;
    formatActions << ui->actionFormatItalic;
    formatActions << ui->actionFormatUnderline;
    formatActions << ui->actionFormatStrikethrough;
    formatActions << ui->actionFormatAlignLeft;
    formatActions << ui->actionFormatAlignCenter;
    formatActions << ui->actionFormatAlignRight;
    formatActions << ui->actionFormatAlignJustify;
    formatActions << ui->actionEditCopy;
    formatActions << ui->actionEditCut;
    formatActions << ui->actionEditPaste;
    formatActions << ui->actionEditRedo;
    formatActions << ui->actionEditSelectAll;
    formatActions << ui->actionEditUndo;
    formatActions << ui->actionCreateLink;
    ui->formatTB->addActions(formatActions);
    ui->formatTB->setToolButtonStyle(Qt::ToolButtonIconOnly);
}
